...
const FourthSection = () => {
  return (
    <div className='mx-4 py-4 md:py-16 space-y-4 md:mx-12  lg:mx-28 lg:justify-center
       ...
       md:grid my:10 '>
        ...
        <div className='md:col-start-2 md:row-start-1 md:row-span-2 md:h-full
        '>
        <Options/>
        </div>

        <p className='hidden md:inline-flex flex-row md:col-start-2 md:row-start-3 lg:ml-0 text-sm '> <GoArrowUpRight size={36} className='text-green-500 mr-1 font-bold'/> Famtech is helping farmers and agribusinesses across
             Nigeria and beyond increase yields, cut costs, and unlock new levels of profitability.</p>
        
        
        <div className='bg-green-600 p-4 md:py-6 md:h-full text-white space-y-4 rounded-xl md:col-start-1 md:row-start-1'>
        ...
        <div className='bg-green-800 max-w-[320px] md:max-w-full mx-auto md:ml-0 space-y-5 lg:space-y-8
